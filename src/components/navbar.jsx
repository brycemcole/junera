...
export default function Navbar() {
  ...
  return (
    <nav className="bg-accent/25 dark:bg-background backdrop-blur-md max-w-4xl mx-4 md:mx-auto shadow-sm z-100 m-4 border rounded-lg mb-0 border-muted-accent">
